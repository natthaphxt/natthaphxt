...
| 🏫 **Organization** | SOLAR-NEXT-GEN |
| 🔍 **Seeking** | Robotics internship · Research collaboration |
...
- 🤖 **[Cart-Pole Simulation](https://github.com/natthaphxt/Cart-Pole-Simulation-MATLAB)** — Swing-up & stabilize control in MATLAB
- ☀️ **[SOLAR Transporter](https://github.com/SOLAR-NEXT-GEN/transporter_ws)** — Autonomous transporter system in C
- 🧠 **[DRL-CBF](https://github.com/natthaphxt/DRL-CBF)** — Deep RL with control barrier functions
